        ...
        <div className="space-y-6 justify-between text-gray-600 md:flex flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
          ...
          <div className="md:7/12 lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900 md:text-4xl dark:text-white">
              Comprehensive Legal Coverage for Egyptian Law
            </h2>
            <p className="my-8 text-gray-600 dark:text-gray-300">
              Our AI platform is trained on Egyptian Constitution, Civil Code,
              Commercial Code, Personal Data Protection Law, and all relevant
              technology laws. Get expert-level legal analysis instantly.
            </p>
            <div className="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
              <div className="mt-8 flex gap-4 md:items-center">
                ...
                <div className="w-5/6">
                  <h3 className="font-semibold text-lg text-gray-700 dark:text-indigo-300">
                    Instant Legal Alerts
                  </h3>
                  <p className="text-gray-500 dark:text-gray-400">
                    Get notified of legal conflicts and risks immediately.
                  </p>
                </div>
              </div>
              <div className="pt-4 flex gap-4 md:items-center">
                ...
                <div className="w-5/6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Pinpoint exact clauses with legal conflicts or ambiguities.
                  </p>
                </div>
              </div>
            </div>
